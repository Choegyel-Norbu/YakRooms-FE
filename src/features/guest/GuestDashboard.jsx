    ...
    >
      ...
      {(booking.status === "CONFIRMED" || 
        ...
        <button
          ...
          className="absolute bottom-3 right-3 bg-[#25D366] hover:bg-[#20BA5A] text-white p-2.5 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 group z-10"
